...
```
From this graph we can see that most of the rental units with missing data are "Extremely Low Income Units". In the data set introduction we know that some information was considered confidential because it was related to a "special population". This suggests that projects involving extremely low income units may be more likely to be associated with confidential or protected populations. 
