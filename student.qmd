...
For the convenience of data analysis and interpretation, I grouped the 65 questions into nine topics according to [Framework & School Survey Scoring
Technical Guide | 2021](https://panorama-www.s3.amazonaws.com/clients/nycdoe/Framework%20&%20School%20Survey%20Scoring%20Technical%20Guide%202021%20Final.pdf), an explanation of the survey published by the New York City Department of Education. Please note that, since not all questions from the student survey are included in the guide, I manually categorize some of the survey questions. The nine topics are:

1. Diversity, Equity, & Inclusion (DEI)
2. Emotional Well-Being
3. Course Clarity
4. Personal Attention and Support
5. Academic Press
6. Student-Teacher Trust
7. Safety
8. Preventing Bullying
9. Guidance

There are three details about the dataset that are worth flagging. First, the surveys were completed in 2021, during the pandemic school year, so class formats were unusual, mainly remote or hybrid, so students were not exposed to the usual school climate. Second, questions q14-16 and q50-q56 are negatively framed, asking about negative emotions and illegal activities; therefore, I reverse-coded these items so that higher percentages consistently indicate better learning environments across the dataset. Third, grades restrict two question blocks: q57-q58 (high school application support) are asked only of grades 6-8, and q59-q65 (college and career readiness) are asked only for grades 9-12; we will analyze the structural pattern of such missing values in the next section.
...
As expected, we found that 46 schools failed to submit their responses. Now, let's remove these schools from our cleaned dataset to reduce noise, but we should be aware that this removal could introduce bias. Then, we will re-examine the missing value using the bar chart.
...
#### Question 1.2: examining the question-level intragroup differences for the two lowest rated topics
...
The exploration of the [2021 Public Data File -Student](https://data.cityofnewyork.us/Education/2021-Public-Data-File-Student/gdx6-nrns/about_data) reveals three main takeaways. First, NYC public school students generally perceived their schools as inclusive and supportive but felt notably less engaged academically and emotionally. Second, although the five boroughs differ in level, all boroughs share a similar shape across the topics, indicating that NYC students' perceptions of school climate are city-wide rather than borough-specific. Third, there is no significant correlation between response rate and climate score, suggesting that the above patterns are not influenced by who chose to respond to the surveys.
